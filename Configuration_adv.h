...
// LCD Print Progress options
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         PA8 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24 V        // All axes (override below)
